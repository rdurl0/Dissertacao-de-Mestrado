...
* `spdep`: para análises com econometria espacial
* `wesanderson`: para uma paleta de cores estilosa
...
quadro_homic_trimestre <- annotate_figure( # A figura:
                                          ...
                                          top     = text_grob(
"Figura 1: Ocorrências de homicídios no Estado de São Paulo\n3°Trim - 1995 até 1°Trim - 2016",
                                             color  = "black",
                                             vjust = .5,
                                             size   = 10,
...
quadro_percs <- annotate_figure(quadro_percs,
                                top     = text_grob(
"Figura 2: Proporção de ocorrências de homicídios e população residente por região\n(2000 até 2010)",
                                   color  = "black",
                                   vjust = .5,
                                   size   = 10,
                                   family = "Times", just = "center"),
...
### Figura 1: Histograma e boxplot da taxa de homicídios por ano de referência:
...
### Figura 2: Taxas de homicídio por seccional (2000 e 2010):
...
Após criar o objeto, é possível checar sua estrutura com `summary()`
```{r }
...
Agora que temos a matriz pronta no `R`, trabalharemos com objetos `r class(listw)`
...
### Figura 2: Taxas de homicídio por seccional (2003 e 2013):
