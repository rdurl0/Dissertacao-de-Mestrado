...
stargazer::stargazer(Capital, digits = 2, type="latex", header=FALSE, 
                     title="Estatísticas descritivas - Capital")

stargazer::stargazer(`Grande SP`, digits = 2, type="latex", header=FALSE, 
                     title="Estatísticas descritivas - Grande SP")

stargazer::stargazer(Interior, digits = 2, type="latex", header=FALSE, 
                     title="Estatísticas descritivas - Interior")
...
A diferença entre as taxas de crimes entre as cidades do interior do estado e a capital São Paulo se contrasta com as discussões recentes que tratam sobre a influência das características locais (ou intra-urbanas) sobre o crime em uma determinada localidade [@glaeser1999there].
