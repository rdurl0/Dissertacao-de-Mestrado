...
V1		# Óbitos por causas externas (por local de residência/DATASUS)
...
até_5		# Domicílios part perm com rendimento até 5 s.m.
X5_a_10	# Domicílios part perm com rendimento >5 até 10 s.m
X10_a_20	# Domicílios part perm com rendimento >10 até 20 s.m
...
Q74		# Número de prisões efetuadas (SSP)
...
AC_1		# Área construída 1 - uso residêncial horizontal de baixo padrão (TCPL/SEMPLA/SMDU)
AC_2		# Área construída 2 - uso residêncial horizontal de médio padrão (TCPL/SEMPLA/SMDU)
AC_3		# Área construída 3 - uso residêncial horizontal de alto padrão (TCPL/SEMPLA/SMDU)
AC_4		# Área construída 4 - uso residêncial vertical de médio padrão (TCPL/SEMPLA/SMDU)
AC_5		# Área construída 5 - uso residêncial vertical de alto padrão (TCPL/SEMPLA/SMDU)
...
AC_10		# Área Construída 10 - Uso Especial ( Hotel, Hospital, Cartório, Etc. )
AC_11		# Área Construída 11 - Uso Escola
AC_12		# Área Construída 12 - Uso Coletivo ( Cinema, Teatro, Clube, Templo, Etc. )
AC_14		# Área construída 14 - uso residêncial vertical de baixo padrão (TCPL/SEMPLA/SMDU)
...
crimes <- c("Homicídio (Q22)", "Tentat Homicídio (Q24)", "Lesão Corporal dol.(Q27)",
            ...
            "Furto - outros (Q44)", "Óbitos por agressão (V1)")
