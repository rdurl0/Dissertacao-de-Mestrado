...
ht <- huxreg(jov1524,
        ...
        mandato,
        flagrante,
        densidade, coefs=c("log(dados2013$jov1524)"="Jovens1524",
                           "log(dados2013$rendamedia)"="Renda Média",
                           "log(dados2013$dprendamedia)"="dp Renda Média",
                           "log(dados2013$favela)"="Favela",
                           "log(dados2013$eformais)"="Empregos/pop",
                           "log(dados2013$mandato)"="Prisões Mandato",
                           "log(dados2013$flagrante)"="Prisões Flagr.",
                           "log(dados2013$densidade)"="dens. demogr."),
                   bold_signif = 0.05)
```
...
```{r output: grafboxplot, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra03, echo=FALSE, fig.height=12, fig.width=18, message=FALSE, warning=FALSE}
...
```{r output: grafbarra13, echo=FALSE, fig.height=12, fig.width=18, message=FALSE, warning=FALSE}
...
```{r output: grafbarra1, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra2, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra3, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra4, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra5, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra6, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra7, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: grafbarra8, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r output: tabela1, echo=FALSE, message=FALSE, results="asis", warning=FALSE}
print(ht)
```
