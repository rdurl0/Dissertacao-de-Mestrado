...
dados$homicz <- scale(dados$homic, center = TRUE, scale = TRUE)
...
barra1 <- ggplot(data = filter(pdados, seccional == "1 CENTRO"),
           ...
           annotate("text", y = 187.5, x=5.5, label = "Seccional 2:\nSul", color="black") +
           annotate("rect", ymin=170, ymax=205, xmin=4.6, xmax=6.4, alpha = .1)
...
barra3 <- ggplot(data = filter(pdados, seccional == "3 OESTE"),
           ...
           scale_y_continuous(limits = c(0,255),
                              breaks = c(0,25,50,75,100,125,150,175,200,225,250)) +
           annotate("text", y = 187.5, x=11, label = "Seccional 3:\nOeste", color="black") +
           annotate("rect", ymin=170, ymax=205, xmin=9.1, xmax=12.8, alpha = .1)
...
barra4 <- ggplot(data = filter(pdados, seccional == "4 OESTE"),
          ...
          scale_y_continuous(limits = c(0,255),
                            breaks = c(0,25,50,75,100,125,150,175,200,225,250)) +
          annotate("text", y = 187.5, x=7.7, label = "Seccional 4:\nOeste", color="black") +
          annotate("rect", ymin=170, ymax=205, xmin=6.5, xmax=8.9, alpha = .1)
...
barra5 <- ggplot(data = filter(pdados, seccional == "5 LESTE"),
              ...
              scale_y_continuous(limits = c(0,255),
                                 breaks = c(0,25,50,75,100,125,150,175,200,225,250)) +
              annotate("text", y = 187.5, x=8, label = "Seccional 5:\nLeste", color="black") +
              annotate("rect", ymin=170, ymax=205, xmin=6.7, xmax=9.3, alpha = .1)
...
barra6 <- ggplot(data = filter(pdados, seccional == "6 SANTO AMARO"),
          ...
          scale_y_continuous(limits = c(0,255),
                             breaks=c(0,25,50,75,100,125,150,175,200,225,250)) +
          annotate("text", y = 187.5, x=8.5, label = "Seccional 5:\nSanto Amaro", color="black") +
          annotate("rect", ymin=170, ymax=205, xmin=7, xmax=10, alpha = .1)
...
barra7 <- ggplot(data = filter(pdados, seccional == "7 ITAQUERA"),
           ...
           scale_y_continuous(limits = c(0,255),
                              breaks = c(0,25,50,75,100,125,150,175,200,225,250)) +
           annotate("text", y = 187.5, x=8.5, label = "Seccional 7:\nItaquera", color="black") +
           annotate("rect", ymin=170, ymax=205, xmin=7, xmax=10, alpha = .1)
...
barra8 <- ggplot(data = filter(pdados, seccional == "8 SÃO MATEUS"),
           ...
           scale_y_continuous(limits = c(0,255),
                              breaks =c (0,25,50,75,100,125,150,175,200,225,250)) +
           annotate("text", y = 187.5, x=6.8, label = "Seccional 8:\nSão Mateus", color="black") +
           annotate("rect", ymin=170, ymax=205, xmin=5.7, xmax=7.9, alpha = .1)
